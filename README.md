...
* Login Features (use APIs) & Database: So the website can be opened on any device, users can log in, and the To-Dos can be viewed anywhere, anytime.  || DONE ||
* Reminder/Alerts: Sending automated mails once logged in, and due date/time set.
* Mailing Functionality to be added 
...
*   Vaibhav Rai (vaibhavrai2104@gmail.com)
